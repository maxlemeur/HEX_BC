 ...
 */
// Source unique de l analyse numerique : voir lib/estimates/editor-values.
// `parseDecimalDraft` conserve son nom historique (cellules K FO / K MO, ou un
// champ vide doit retomber sur la valeur neutre et non sur 0).
export { parseNumberInput };
export { parseNullableNumberInput as parseDecimalDraft };
