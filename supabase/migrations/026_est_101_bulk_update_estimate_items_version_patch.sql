-- EST-101: extend bulk update RPC with optional estimate version totals patch.
...
-- Consolidated from 026_suggestion_scoring.sql to keep migration versions unique.
