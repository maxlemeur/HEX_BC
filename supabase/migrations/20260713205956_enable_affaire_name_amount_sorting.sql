-- Add stable keyset pagination for updated date, project name, and current total.
-- Keep the function security-invoker so the existing RLS model remains active.
...
create function public.list_affaires_page(
  p_tenant_id uuid,
