...
-- updated_at trigger
drop trigger if exists set_labor_roles_updated_at on public.labor_roles;
...
-- Consolidated from 20260305150000_est_e13_portal_email_tables.sql to keep migration versions unique.
