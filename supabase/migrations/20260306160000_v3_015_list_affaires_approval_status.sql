-- V3-015: expose approval_status in list_affaires_page for list-level visibility.
...
-- Also fix get_affaires_counters: allow directors (p_owner_user_id = null) to pass the scope check.
