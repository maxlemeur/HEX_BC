-- EST-118: enforce optimistic-concurrency token atomically in bulk item updates.
...
-- Consolidated from 025_estimate_templates_est181.sql to keep migration versions unique.
