...
- [ ] Un validateur qui ouvre depuis une file d'approbation arrive par défaut en mode `Validation`

### Pourquoi ce changement

- **Marie** a une expérience réellement guidée.
- **Laurent** garde la table de production complète.
- **Nadia** dispose enfin d'un mode dédié à sa façon de travailler.

---

## V3-013 - Plans dans flow import -> "Intake enrichi"
...
> En tant que chiffreur, je veux pouvoir intégrer les plans au moment de l'ouverture d'une affaire, afin d'éviter un onboarding fragmenté entre import DPGF et workflow plans.

### Critères d'acceptation mis à jour

- [ ] Le flow import propose explicitement l'étape `Ajouter les plans`
- [ ] Cette étape reste optionnelle mais fortement recommandée
- [ ] Le produit explique à quoi serviront les plans :
  - extraction de mètres
  - preuves
  - détection des écarts
- [ ] Après upload, le produit affiche :
  - nombre de fichiers
  - sets détectés ou proposés
  - prochaine action suggérée
- [ ] L'utilisateur peut ignorer l'étape sans bloquer la création de l'affaire
- [ ] Si des plans sont présents, le hub affaire reflète immédiatement leur disponibilité
- [ ] Le wording reste cohérent avec l'intake global du dossier

### Pourquoi ce changement

- **Marie** comprend mieux le bénéfice des plans.
- **Laurent** évite de perdre une étape critique entre deux écrans.
- **Nadia** profite en aval d'une affaire mieux préparée.

---

## V3-014 - Auto-trigger mètre -> "Auto-proposition fiable"
...
> En tant que chiffreur, je veux que le produit me propose automatiquement de lancer un premier mètre au bon moment, afin de gagner du temps sans subir des analyses inutiles ou mal ciblées.

### Critères d'acceptation mis à jour

- [ ] Après upload de plans, le produit propose `Lancer une première analyse`
- [ ] La proposition n'est affichée que si :
  - un plan set exploitable existe
  - une version cible cohérente existe ou peut être créée
  - le contexte affaire est suffisamment initialisé
- [ ] Le produit explique ce qu'il va faire :
  - niveau recommandé
  - version cible
  - bénéfice attendu
- [ ] L'utilisateur peut :
...
- [ ] Les préférences de non-affichage sont mémorisées sans masquer les CTA manuels
- [ ] Un auto-trigger ne doit jamais créer silencieusement un job incompréhensible
- [ ] Le premier job créé apparaît immédiatement dans l'activity center

### Pourquoi ce changement

- **Marie** bénéficie d'une aide proactive mais contrôlée.
- **Laurent** garde une compréhension claire des analyses lancées.
- **Nadia** hérite d'un workflow plus régulier entre affaires.
